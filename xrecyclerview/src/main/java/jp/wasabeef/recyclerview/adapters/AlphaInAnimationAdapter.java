...
public class AlphaInAnimationAdapter extends AnimationAdapter {
  ...
  @Override protected Animator[] getAnimators(View view) {
    return new Animator[] { ObjectAnimator.ofFloat(view, "alpha", mFrom, 1f),ObjectAnimator.ofFloat(view, "scaleX", mFrom, 1f),ObjectAnimator.ofFloat(view, "scaleY", mFrom, 1f) };
  }
}
