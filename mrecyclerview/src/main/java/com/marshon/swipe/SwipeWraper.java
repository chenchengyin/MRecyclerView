...
public class SwipeWraper extends FrameLayout {
    ...
    public SwipeWraper(Context context, AttributeSet attrs, int defStyle) {
        ...
        int dragEdgeChoices = a.getInt(R.styleable.SwipeWraper_drag_edge, DRAG_RIGHT);
        ...
        int ordinal = a.getInt(R.styleable.SwipeWraper_show_mode, ShowMode.PullOut.ordinal());
